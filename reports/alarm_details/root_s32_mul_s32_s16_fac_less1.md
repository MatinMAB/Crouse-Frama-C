...
harness: `harnesses/P0/eva_main_root_s32_mul_s32_s16_fac_less1.c`  
machdep: `ppc_32`
...
- `factor`: بازه کامل `s16`، از `-32768` تا `32767`
...
`src_analysis/sources/mul_Ccode.c:5071`
...
`src_analysis/sources/mul_Ccode.c:5089`
...
`src_analysis/sources/mul_Ccode.c:5090`
